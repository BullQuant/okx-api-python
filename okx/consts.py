...
MARKET_TICKERS_INFO = '/api/v5/market/tickers'
MARKET_TICKER_INFO = '/api/v5/market/ticker'
MARKET_INDEX_TICKERS = '/api/v5/market/index-tickers'
MARKET_ORDER_BOOKS = '/api/v5/market/books'
MARKET_MARKET_CANDLES = '/api/v5/market/candles'
MARKET_HISTORY_CANDLES = '/api/v5/market/history-candles'
MARKET_INDEX_CANSLES = '/api/v5/market/index-candles'
MARKET_MARKPRICE_CANDLES = '/api/v5/market/mark-price-candles'
MARKET_TRADES = '/api/v5/market/trades'
MARKET_24_VOLUMNE = '/api/v5/market/platform-24-volume'
MARKET_OPEN_ORACLE = '/api/v5/market/open-oracle' #need to update? if it is open oracle
MARKET_INDEX_COMPONENTS = '/api/v5/market/index-components' #need to add
...
PUBLIC_INSTRUMENT_INFO = '/api/v5/public/instruments'
PUBLIC_DELIVERY_EXERCISE = '/api/v5/public/delivery-exercise-history'
...
PUBLIC_DICCOUNT_INTETEST_INFO = '/api/v5/public/discount-rate-interest-free-quota'
PUBLIC_SYSTEM_TIME = '/api/v5/public/time'
PUBLIC_LIQUIDATION_ORDERS = '/api/v5/public/liquidation-orders'
